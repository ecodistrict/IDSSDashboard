        ...
        if(moduleData.variantId && moduleData.moduleId && moduleData.kpiAlias) {
            Variant.findById(moduleData.variantId, function(err, variant) {
                ...
                if(err) {
                    ...
                    var outputData = _.reject(variant.outputData, function(o) {return o.kpiAlias === moduleData.kpiAlias && o.moduleId === moduleData.moduleId;});
                    // add new result data
                    outputData.push(moduleOutput);
                    variant.outputData = outputData;

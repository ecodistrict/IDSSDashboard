exports.addRoutes = function (app, variant, userDependency, processDependency) {
	...
	app.delete('/variants/moduleinput/:kpiId', variant.deleteModuleInput);
	app.delete('/variants/moduleoutput/:kpiId', variant.deleteModuleOutput);
	app.get('/variants', variant.getVariants);
	app.get('/variants/processid', variant.getVariantsByProcessId);
	app.get('/variants/:variantId', variant.getVariant);
	app.get('/variants/moduleinput/:variantId/:moduleId/:kpiId/:asIsVariantId', variant.getModuleInput);
